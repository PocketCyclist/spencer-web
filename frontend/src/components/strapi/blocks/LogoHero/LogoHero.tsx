...
export const LogoHero = ({ bgImage }: LogoHeroProps) => (
  <section className="relative bg-gray-300 text-white rem:h-[500px]  lg:min-h-screen-minus-header  ">
    ...
    <Image
      ...
      className="absolute bottom-20 left-1/2 h-auto max-w-[calc(100%-2rem)] -translate-x-1/2 rem:w-[280px] md:hidden lg:bottom-1/2 lg:translate-y-1/2 lg:rem:w-[740px] "
